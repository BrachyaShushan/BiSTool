...
import { ExtendedSession, ExtendedVariable, ModalType } from "../types/SavedManager";
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex space-x-2">
                                            ...
                                            <button
                                                onClick={() =>
                                                    handleSessionAction("duplicate", session as ExtendedSession)
                                                }
                                                className={`px-3 py-1 rounded-md text-sm font-medium ${isDarkMode
                                                        ...
                                                        <button
                                                            onClick={() => {
                                                                const updatedSession: ExtendedSession = {
                                                                    ...
                                                                    activeSection: activeSession.activeSection || "url",
                                                                };
