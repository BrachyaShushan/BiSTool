...
const Tooltip: React.FC<TooltipProps> = ({
    ...
    return (
        ...
        >
            ...
            {isVisible && (
                <div
                    className={`absolute z-50 px-3 py-2 text-sm font-medium text-white bg-gray-800 dark:bg-gray-200 dark:text-gray-800 rounded-lg shadow-lg ${multiline ? 'whitespace-normal max-w-xs' : 'whitespace-nowrap'
